...
public class MoviesRepository {
  ...
  private SparseArray<MovieData> movies;
  ...
  public void _addAll(List<MovieData> movieList){
  ...
  public void add(TheMovieDbObject movieDbObject, CustomGridAdapter.SortOptions option){
    ...
    for (MovieData movie: movieDbObject.getResults()) {
      movies.put(movie.getId(), movie);
  ...
  public List<MovieData> getMoviesByPage(int page, CustomGridAdapter.SortOptions options){
